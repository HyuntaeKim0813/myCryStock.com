...
async function signup(req,res,next){
    ...
    if(
        ...
        sessionFlash.flashDataToSession(req, {
            errorMessage: 'Please check your input. Password must be at least 6 characters long, post code must be 5 characters',
            ...enteredData
        }, function(){
            res.redirect('/signup');
        })
    ...
    try {
        const exsitsAlready = await user.existsAlready();
        ...
        if(exsitsAlready){
            ...
            // res.render() | When we render it will work as post request
            return;
        }
